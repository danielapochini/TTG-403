...
getLoginR = do
        ...
        toWidget $ $(cassiusFile "templates/cassius/login.cassius")
        toWidgetHead [hamlet|
                <meta charset="utf-8">
                        ...
                        <div ."container fundo1">
                            <div ."row">
                                <div ."col-md-12">
                                  ...
                                  <p>Em instantes você será redirecionado para nossa página principal.
                                  <br> Obrigado!
                    <div ."section">
                        <footer ."container">
                            <div ."vcard row">
            ...
            toWidget[whamlet| 
                    <div ."section">
                        <div ."container fundo1">
                            <div ."row"> 
                                <div ."col-md-12">
                                    <h1>Área do Administrador
                                <div ."col-md-4">
                                    <h3> Cadastro de Administrador
                                    <input type="button" onClick="location.href='@{UsuarioR}'" value="Cadastrar">
                                <div ."col-md-4">
                                    <h3> Cadastro de Funcionário 
                                    <input type="button" onClick="location.href='@{UsuarioR}'" value="Cadastrar">
                                <div ."col-md-4">
                        ...
                        <div ."container fundo1">
                                ...
                                <div ."col-md-12">
                                    <div ."col-md-5">
                                        <h2>Localização
                                        <div ."googlemaps">
                                            <iframe width="425" height="350" frameborder="0" scrolling="no" marginheight="0"  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3646.061387900585!2d-46.32303458501465!3d-23.958269284487358!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x94ce03a6e8657c03%3A0x8cc26677fac63151!2sAv.+Afonso+Pena%2C+45+-+Macuco%2C+Santos+-+SP%2C+11020-001!5e0!3m2!1spt-BR!2sbr!4v1450190185943" ."lado1 borda">
                                    <div ."col-md-7">
                                        <h2>Email
